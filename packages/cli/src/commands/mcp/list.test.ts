...
import { createTransport } from '@blackbox_ai/blackbox-cli-core';
...
vi.mock('@blackbox_ai/blackbox-cli-core', () => ({
  ...
  Storage: vi.fn().mockImplementation((_cwd: string) => ({
    getGlobalSettingsPath: () => '/tmp/blackbox/settings.json',
    getWorkspaceSettingsPath: () => '/tmp/blackbox/workspace-settings.json',
    getProjectTempDir: () => '/test/home/.blackboxcli/tmp/mocked_hash',
  })),
  GEMINI_CONFIG_DIR: '.blackboxcli',
