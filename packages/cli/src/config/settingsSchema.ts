    ...
    properties: {
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectGeminiIgnore: {
            type: 'boolean',
            label: 'Respect .blackboxignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .blackboxignore files when searching',
            showInDialog: true,
          },
  ...
  experimental: {
    ...
    properties: {
      ...
      visionModelPreview: {
        ...
        default: true,
        description:
          'Enable vision model support and auto-switching functionality. When disabled, vision models like blackbox-vl-max-latest will be hidden and auto-switching will not occur.',
        showInDialog: true,
      },
      vlmSwitchMode: {
        type: 'string',
