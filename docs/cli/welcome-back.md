...
When you start Blackbox Code in a project directory that contains a previously generated project summary (`.blackboxcli/PROJECT_SUMMARY.md`), the Welcome Back dialog will automatically appear, giving you the option to either start fresh or continue your previous conversation.
...
- **Project Summary File:** Looks for `.blackboxcli/PROJECT_SUMMARY.md` in your current project directory
...
2. **Continue previous conversation**
   - Automatically fills the input with: `@.blackboxcli/PROJECT_SUMMARY.md, Based on our previous conversation, Let's continue?`
...
- **User settings:** `~/.blackboxcli/settings.json` (affects all projects)
- **Project settings:** `.blackboxcli/settings.json` (project-specific)
...
2. **Automatic Detection:** Next time you start Blackbox Code in this project, Welcome Back will detect the summary
